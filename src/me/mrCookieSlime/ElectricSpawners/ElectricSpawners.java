...
public class ElectricSpawners extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		try {
			category = new Category(new CustomItem(CustomSkull.getItem("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGI2YmQ5NzI3YWJiNTVkNTQxNTI2NTc4OWQ0ZjI5ODQ3ODFhMzQzYzY4ZGNhZjU3ZjU1NGE1ZTlhYTFjZCJ9fX0="), "&9Spawners Electricos", "", "&a> Click para abrir"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		
		Research research = new Research(4820, "Spawners Electrificados", 30);
